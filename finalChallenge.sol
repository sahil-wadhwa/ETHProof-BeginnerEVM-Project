...
4.  Your contract will have a burn function, which works the opposite of the mint function, as it will destroy tokens. It will take an address and value just like
...
contract FirstToken{
    ...
    function mintingToken(address _address, uint _value) public{
        balances[_address]+=_value;
        totalSupply+=_value;
    }
    function burningToken(address _address,uint _value) public {
